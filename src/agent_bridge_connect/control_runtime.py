"""Durable task-scoped control-plane runtime.

The public compatibility facade is agent_bridge_connect.control. This module
owns the stateful control-plane implementation and imports only protocol,
transport, permission-runtime, and session contracts.
"""
